...
const questionsEn: LocaleQuestion[] = [
  ...
  { id: 'eq15', category: 'Basics',    title: "What do you always say when introducing yourself?", sponsor: null },
  { id: 'eq16', category: 'Basics',    title: 'If you could only take one thing to a desert island, what would it be?', sponsor: null },
  { id: 'eq17', category: 'Basics',    title: 'Message to yourself 10 years from now?', sponsor: null },
...
const questionsKo: LocaleQuestion[] = [
  ...
  { id: 'kq15', category: '기본',   title: '자기소개 때 꼭 말하는 것은?', sponsor: null },
  { id: 'kq16', category: '기본',   title: '무인도에 딱 하나만 가져간다면?', sponsor: null },
  { id: 'kq17', category: '기본',   title: '10년 후의 나에게 한 마디?', sponsor: null },
...
const questionsZh: LocaleQuestion[] = [
  ...
  { id: 'zhq15', category: '基础',  title: '自我介绍时必说的一句话？', sponsor: null },
  { id: 'zhq16', category: '基础',  title: '荒岛只能带一样东西，会带什么？', sponsor: null },
  { id: 'zhq17', category: '基础',  title: '给10年后的自己说一句话？', sponsor: null },
...
const questionsZhTw: LocaleQuestion[] = [
  ...
  { id: 'twq15', category: '基礎',  title: '自我介紹時必說的一句話？', sponsor: null },
  { id: 'twq16', category: '基礎',  title: '荒島只能帶一樣東西，會帶什麼？', sponsor: null },
  { id: 'twq17', category: '基礎',  title: '給10年後的自己說一句話？', sponsor: null },
...
const questionsTh: LocaleQuestion[] = [
  ...
  { id: 'thq15', category: 'ทั่วไป',    title: 'สิ่งที่ต้องพูดตอนแนะนำตัวคืออะไร?', sponsor: null },
  { id: 'thq16', category: 'ทั่วไป',    title: 'ถ้าไปเกาะร้าง พาอะไรไปได้ชิ้นเดียว?', sponsor: null },
  { id: 'thq17', category: 'ทั่วไป',    title: 'ฝากข้อความถึงตัวเองใน 10 ปีข้างหน้า?', sponsor: null },
