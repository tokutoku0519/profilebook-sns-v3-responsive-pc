...
export function VegetableEmoji({ id, label, size = 24 }: { id?: string; label?: string; size?: number }) {
  ...
  return <img src={`/vegetables/${resolvedId}.png?v=6`} width={size} height={size} alt={resolvedLabel} title={resolvedLabel} className="pixel-emoji-image inline-block shrink-0 align-middle [image-rendering:pixelated]" />;
}
